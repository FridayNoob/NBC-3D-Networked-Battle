...
namespace NBC.ConfigKit.SelfTest
{
    ...
    internal static class Program
    {
        ...
        private static int Main()
        {
            ...
            Run("代码生成：各类型的字面量", CodeGen_Literals);
            Run("代码生成：SO 含主键索引与 Get/TryGet", CodeGen_ScriptableObjectHasIndex);
        ...
        private static void CodeGen_FieldsAndTypes()
        {
            ...
            CheckContains(code, "public int? buffId;", "可空外键 → int?");
        ...
        private static void CodeGen_Literals()
        {
            ...
            CheckEqual("null", Literal("ref:Buff?", ""), "可空字段留空 → null");
        }
